...
"Obtain 3 different items of the following: Mist Battlestaff, Dust Battlestaff, Black Tourmaline Core, Leaf Bladed Battleaxe, Black Mask, Aranea Boots, or Basilisk Jaw (2,4)",
"Obtain 2 of the following (Dragon Harpoon, Drake Claw, Drake Tooth, Hydra Tail, Hydra Claw, or Hydra Leather) (2,5)",
"Obtain 3 of the following (Pharaoh's Sceptre, Gnome Scarf, Elven Signet, Shield Left Half, Imcando Hammer, or any Big Fish (bass, shark, swordfish)) (2,6)",
...
"Obtain one of the following: Pet, Shadow, Lightbearer, Osmumten's Fang, Ward, or any Masori piece (4,1)",
"Obtain 2 of the following (Abyssal Lantern, Crystal Tool Seed, Ring of Endurance, Tome of Fire or Big Harpoon fish) (4,2)",
...
"Obtain all of the following items: broken zombie axe, broken zombie helm, warped sceptre, Sarachnis cudgel, glacial temotli (5,1)",
"Subdue Herbiboar 1500 times (5,2)",
"Obtain any Chambers of Xeric Unique (Twisted Buckler, DHC, Dinh's, Ancestral, Claws, Maul, Kodai) (5,3)",
